    ...
    return (
        <div className="w-full bg-white font-sans antialiased text-black">
            <main
                ...
                style={{ backgroundImage: "url('/mounted.png')" }}
            >
            ...
            {/* ================= CONTENT SECTION WITH TOP GAP SPACE ================= */}
            {/* mt-12 md:mt-16 adds the precise layout space gap right beneath the pool banner */}
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 lg:gap-16 items-center">
                    ...
                    <div className="md:col-span-6 order-2 md:order-1 flex flex-col justify-center items-start text-left">
                        <h2 className="text-2xl sm:text-3xl md:text-[34px] font-bold text-neutral-900 tracking-tight leading-tight font-sans">
                            The Perfect Solution for Stylish and Space-Saving Outdoor Comfort
                        </h2>
                        <div className="mt-5 flex flex-col gap-4 text-xs sm:text-sm text-neutral-600 leading-relaxed font-normal">
                            <p>
                                Mounted pergolas on brackets provide an elegant, space-efficient way to create beautiful shaded areas. Fixed to an existing wall with durable brackets, these pergolas are ideal for patios, balconies, or any space where the ground area is limited. Their sleek, modern design blends seamlessly with your home's architecture, offering a refined and stylish look while delivering practical benefits.
                            </p>
                            <p>
