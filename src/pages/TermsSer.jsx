...
const TermsSer = () => {
    return (
        <>
            {/* FIXED NAVBAR BACKGROUND STRIP: Sirf is page par navbar ke peeche solid black block toggle karega */}
            <div className="fixed top-0 left-0 w-full h-20 sm:h-18 bg-black z-40 pointer-events-none" />

            {/* Main Container: pt-24 (mobile) aur sm:pt-36 (desktop) se content black navbar ke theek neeche space maintain karega */}
            <section className="w-full bg-white pt-24 sm:pt-36 pb-16 px-4 sm:px-12 lg:px-24 text-black font-sans antialiased box-border">
                <div className="max-w-5xl mx-auto flex flex-col items-center md:items-start w-full">

                    {/* Main Heading Styled like Figma */}
                    <h1 className="text-3xl sm:text-5xl md:text-[52px] font-bold text-neutral-900 tracking-tight mb-8 sm:mb-12 text-center md:text-left w-full break-words">
                        Terms of service
                    </h1>

                    {/* Content Container with Paragraph spacing handles */}
                    <div className="flex flex-col gap-6 sm:gap-8 text-xs sm:text-base text-neutral-700 leading-relaxed text-justify md:text-left font-normal w-full overflow-hidden">

                        {/* OVERVIEW SECTION */}
                        <div className="flex flex-col gap-3">
                            <h3 className="text-sm sm:text-lg font-bold uppercase tracking-wide text-black">
                                OVERVIEW
                            </h3>
                            <p>
                        ...
                        {/* SECTION 6 TO 11 CONDENSED BLOCKS */}
                        <div className="flex flex-col gap-3">
                            <h3 className="text-sm sm:text-lg font-bold uppercase tracking-wide text-black">
                        ...
                        <div className="flex flex-col gap-3 border-t border-neutral-100 pt-6 mt-4">
                            ...
                            <p>
                                Questions about the Terms of Service should be sent to us at <a href="mailto:info@theluxurypergola.com" className="underline font-semibold hover:text-white/80 transition-colors">info@theluxurypergola.com</a>.
                            </p>
                            <p className="font-medium text-black">
                                Our contact information is posted below:<br />
                                <span className="text-neutral-600 font-normal break-all">info@theluxurypergola.com</span>
                            </p>
                        </div>
            ...
            {/* Lower elements injected correctly */}
            <TalkTo />
