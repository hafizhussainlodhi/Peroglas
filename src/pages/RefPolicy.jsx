          ...
          <div className="fixed top-0 left-0 w-full h-20 sm:h-18 bg-black z-40 pointer-events-none" />
            ...
            <section className="w-full bg-white pt-28 sm:pt-36 pb-20 px-6 sm:px-12 lg:px-24 text-black font-sans antialiased">
                <div className="max-w-5xl mx-auto flex flex-col items-center md:items-start">
                    ...
                    <h1 className="text-4xl sm:text-5xl md:text-[52px] font-bold text-neutral-900 tracking-tight mb-12 text-center md:text-left w-full">
                        Refund Policy
                    </h1>

                    {/* Content Container with Paragraph spacing handles */}
                    <div className="flex flex-col gap-8 text-sm sm:text-base text-neutral-700 leading-relaxed text-justify md:text-left font-normal w-full">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <p>
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Facilis placeat tenetur repellendus adipisci voluptatem odio dignissimos, et deleniti voluptatibus ducimus ad nihil officia minus facere quibusdam neque? Autem, molestias accusamus
                            </p>
                            <p>
                        ...
                        <div className="flex flex-col gap-3">
                            <h3 className="text-base sm:text-lg font-bold uppercase tracking-wide text-black">
                                CANCELLATIONS AFTER PACKAGED OR SHIPPED
                            </h3>
                            <p>
                        ...
                        <div className="flex flex-col gap-3">
                            <h3 className="text-base sm:text-lg font-bold uppercase tracking-wide text-black">
                               PARTS MISSING AFTER 5 DAYS OF DELIVERY
                            </h3>
                            <p>
