...
const PlainModern = () => {
    return (
        <div className="w-full bg-white font-sans antialiased text-black">
            ...
            {/* ================= HERO BANNER SECTION ================= */}
            {/* Margins removed so it snaps right underneath the fixed navbar */}
            <main
                ...
                style={{ backgroundImage: "url('/pl-1.png')" }}
            >
                ...
                <div className="relative z-20 w-full max-w-4xl mx-auto px-6 text-center flex flex-col items-center justify-center">
                    <h1 className="text-white text-3xl sm:text-5xl md:text-[52px] font-bold tracking-tight leading-tight select-none">
                        Plain Modern Free-Standing Pergolas
                    </h1>
            ...
            <section className="w-full py-12 md:py-16 px-4 sm:px-8 lg:px-16">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 lg:gap-16 items-center">

                    {/* Left Column Image (pl-2.png) */}
                    <div className="md:col-span-6 w-full">
                        <img
                            src="/pl-2.png"
                            alt="Outdoor Living Setup"
                    ...
                    <div className="md:col-span-6 flex flex-col justify-center items-start text-left">
                        <h2 className="text-2xl sm:text-3xl md:text-[34px] font-bold text-neutral-900 tracking-tight leading-tight font-sans">
                            The Perfect Blend of Style and Functionality for Your Outdoor Space
                        </h2>
                        <div className="mt-5 flex flex-col gap-4 text-xs sm:text-sm text-neutral-600 leading-relaxed font-normal">
                            <p>
                                Plain modern free-standing pergolas bring together a sleek, minimalist design and practical functionality, making them an ideal addition to any contemporary outdoor setting. With clean lines, neutral color palettes, and a lack of ornate details, these pergolas provide a sophisticated touch that seamlessly complements modern homes.
                            </p>
                            <p>
                                Typically crafted from durable materials like aluminum, steel, or composite wood, they offer long-lasting durability with minimal maintenance. These pergolas create an inviting shaded area, perfect for unwinding, dining al fresco, or entertaining guests, while elevating the overall beauty and usefulness of your patio, garden, or terrace.
                            </p>
                        </div>
                    </div>
            ...
            <section className="w-full pb-16 md:pb-20 px-4 sm:px-8 lg:px-16 bg-white">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 lg:gap-16 items-center">

                    {/* Left Column Text Content (Rendered first on desktop) */}
                    <div className="md:col-span-6 order-2 md:order-1 flex flex-col justify-center items-start text-left">
                        <h2 className="text-2xl sm:text-3xl md:text-[34px] font-bold text-neutral-900 tracking-tight leading-tight font-sans">
                            Enhance Your Outdoor Space with Versatile and Stylish Designs
                        </h2>
                        <div className="mt-5 flex flex-col gap-4 text-xs sm:text-sm text-neutral-600 leading-relaxed font-normal">
                            <p>
                                Free-standing pergolas are versatile structures that don't need to be attached to any wall or building. Typically made of support posts and overhead beams, these pergolas can be placed anywhere in an open space like a garden, patio, or terrace. Their design creates inviting, shaded areas perfect for relaxing, hosting gatherings, or enhancing outdoor spaces with an aesthetic and functional touch.
                            </p>
                            <p>
                                Available in a range of materials such as wood, aluminum, and steel, each type offers unique benefits in terms of maintenance and durability. These pergolas are ideal for creating comfortable lounge areas with outdoor furniture. Their structure allows for decorative touches like string lights or mesh screens, creating a cozy and intimate atmosphere.
                            </p>
                        </div>
                    </div>

                    {/* Right Column Image (pl-3.png) */}
                    <div className="md:col-span-6 order-1 md:order-2 w-full">
                        <img
                            src="/pl-3.png"
                            alt="Poolside Luxury Lounge"
                            className="w-full h-auto object-cover rounded-sm shadow-sm select-none"
                        />
                    </div>
