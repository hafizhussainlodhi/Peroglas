          ...
          <main className="col-span-1 lg:col-span-9 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-5 gap-y-8 mt-4">
              {products.map((product) => (
                // Card wrapper ko <div> se badal kar <Link> kar diya gaya hai
                <Link to="/single-product" key={product.id} className="group flex flex-col w-full relative cursor-pointer">
